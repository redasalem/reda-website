...
export default function Certificates() {
  ...
  const certificates = [
  {
    ...
    date: "May 2025",
    description: "Comprehensive front-end development certification covering modern web technologies",
  ...
  },
   {
    ...
    date: "Sep 2022",
    description: "Professional training in front-end development with hands-on projects",
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <span className={`px-4 py-2 bg-linear-to-r ${cert.color} text-white text-sm font-bold rounded-full shadow-lg`}>
                      {cert.date}
                    </span>
                  </motion.div>
                </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    <motion.h3
                      className="text-2xl font-bold text-foreground group-hover:text-transparent group-hover:bg-linear-to-r group-hover:bg-clip-text group-hover:from-purple-400 group-hover:to-pink-400 transition-all duration-300 mb-2"
                    >
                      {cert.title}
                    </motion.h3>
