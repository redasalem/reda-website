  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Express.js", icon: <ExpressIcon sx={{ color: "#000000" }} /> },
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-accent/10 border border-accent/20 backdrop-blur-sm mb-4 md:mb-6">
            ...
            <span className="text-xs md:text-sm font-semibold text-accent">Technical Proficiency</span>
          </div>
            ...
            >
              ...
              <div className="relative flex flex-wrap gap-2 md:gap-3">
                {category.skills.map((skill, idx) => (
                  ...
                  >
                    <span className="flex items-center justify-center w-4 h-4 md:w-5 md:h-5">{skill.icon}</span>
