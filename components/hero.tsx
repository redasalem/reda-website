...
export default function HeroSection() {
  ...
  return (
    <section id='About Me' className="relative min-h-screen overflow-hidden flex items-center bg-background">
      ...
      <div className="container mx-auto px-6 z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Passionate Front-End Developer specializing in <strong className="text-foreground">React</strong>, <strong className="text-foreground">Next.js</strong>, and <strong className="text-foreground">React Native</strong>.
              I transform ideas into elegant, high-performance web and mobile applications with pixel-perfect design and clean, maintainable code.
            </motion.p>
            ...
            >
              ...
              >
                <Link target='_blank' href='https://drive.google.com/file/d/12Ouz2LERVpvFoiy6ZRFlZYFYLNfoO1jD/view' className='flex items-center gap-2'>
              ...
              <div className="bg-linear-to-br from-gray-100 to-gray-200 dark:from-slate-900 dark:to-black rounded-xl overflow-hidden border border-gray-300 dark:border-slate-700 shadow-inner">
                ...
                <div className="p-6 min-h-[400px] relative overflow-hidden bg-white dark:bg-slate-900">
                  ...
                  <motion.div className="space-y-3 font-mono text-sm">
                    {[
                      { code: 'const developer = {', color: 'text-purple-700 dark:text-purple-400', delay: 0 },
                      { code: '  name: "Reda Salem",', color: 'text-blue-700 dark:text-blue-400', delay: 0.1 },
                      { code: '  role: "Front-End Dev",', color: 'text-green-700 dark:text-green-400', delay: 0.2 },
                      { code: '  skills: ["React", "Next.js"],', color: 'text-cyan-700 dark:text-cyan-400', delay: 0.25 },
                      { code: '  passion: "Building Magic ✨"', color: 'text-pink-700 dark:text-pink-400', delay: 0.3 },
                      { code: '}', color: 'text-purple-700 dark:text-purple-400', delay: 0.4 }
                    ].map((line, i) => (
                      <motion.div
                        key={i}
